package com.example.gps_test_v3;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private TextView tvNetworkLatitude, tvNetworkLongitude, tvPassiveLatitude, tvPassiveLongitude;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPassiveLongitude=(TextView)findViewById(R.id.tvPassiveLongitude);
        ...
        if (lastKnownLocation != null) {
            ...
            tvPassiveLongitude.setText(":: " + Double.toString(lng));
        }
        ...
        for (int i =0; i<listProviders.size(); i++) {
            if(listProviders.get(i).equals(LocationManager.GPS_PROVIDER)) {
                ...
                tvNetworkEnable.setText(": " + String.valueOf(isEnable[2]));
    ...
    public void onLocationChanged(Location location) {
        ...
        if(location.getProvider().equals(LocationManager.PASSIVE_PROVIDER)) {
            ...
            tvPassiveLongitude.setText(": " + Double.toString(longitude));
            Log.d(TAG + "GPS: " , Double.toString(latitude) + "/" + Double.toString(longitude));
    ...
    protected void onStart() {
        ...
        if(ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            //권한이 없을 경우 최초 권한 요청또는 사용자에 의한 재요청 확인
